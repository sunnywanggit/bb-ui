<template>
  <div class="bb-slide" ref="slide">
    <div class="bb-slide-group" ref="slideGroup">
      <slot>
        <bb-slide-item
    ...
    <div class="bb-slide-dots" v-if="showDots">
...
import scrollMixin from '../../../src/mixins/scroll';
import deprecatedMixin from '../../../src/mixins/deprecated';
import BbSlideItem from './slide-item.vue';
...
<style lang="less">
@import "../../../assets/styles/varibale.less";
